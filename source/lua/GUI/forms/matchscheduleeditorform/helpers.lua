...
function create_match_containers()
    ...
    for i=0, games_in_current_month-1 do
        ...
        local fixtureList = readMultilevelPointer(readPointer('fixturesData'), {0x18, 0x60})
        local standingsList = readMultilevelPointer(readPointer('fixturesData'), {0x18, 0x88, 0x30})
